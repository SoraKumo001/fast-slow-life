...
export const ITEMS: Record<string, Item> = {
  ...
  wooden_club: {
    ...
    basePrice: 15,
    difficulty: 1.0,
    equipment: { slot: "weapon", bonuses: { attack: 8 } },
  },
  wooden_bow: {
    id: "wooden_bow",
    name: "木の弓",
    ...
    basePrice: 25,
    difficulty: 1.0,
    equipment: { slot: "weapon", bonuses: { attack: 10, agi: 5 } },
  },
  wooden_shield: {
    id: "wooden_shield",
    name: "木の盾",
    ...
    basePrice: 15,
    difficulty: 1.0,
    equipment: { slot: "armor", bonuses: { defense: 5 } },
  },
  leather_armor: {
    id: "leather_armor",
    name: "革の鎧",
    ...
    basePrice: 35,
    difficulty: 1.0,
    equipment: { slot: "armor", bonuses: { defense: 8, agi: 2 } },
  },
  silver_rapier: {
    id: "silver_rapier",
    name: "銀の細剣",
